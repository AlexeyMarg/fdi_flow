...
- `NonlinearityApproximator`: базовый класс для аппроксимации нелинейной динамики по временным рядам
- `MultilevelLinearRegressor`: многоуровневая линейная регрессия (Ridge/Lasso) для аппроксимации сложных зависимостей
